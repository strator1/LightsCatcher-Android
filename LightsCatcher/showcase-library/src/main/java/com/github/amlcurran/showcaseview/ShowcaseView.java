...
public class ShowcaseView extends RelativeLayout
    ...
    private void setScaleMultiplierInternal(float scaleMultiplier) {
        this.scaleMultiplier = scaleMultiplier;
    }

    public void setScaleMultiplier(float scale) {
        this.setScaleMultiplierInternal(scale);
        invalidate();
    }
    ...
    public static class Builder {
        ...
        public Builder withHoloShowcase2() {
            return setShowcaseDrawer(new StandardShowcaseDrawer2(activity.getResources(), activity.getTheme()));
        }
